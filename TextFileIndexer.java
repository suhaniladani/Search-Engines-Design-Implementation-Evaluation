    ...
    while (!s.equalsIgnoreCase("q")) {
      try {
        ...
        for(int i=0;i<hits.length;++i) {
          ...
          //print(" Q0" " " + i + rank + " " + str(docidbm[i])+ " casefolding_punctuation"  + "\n")
          System.out.println(qid + " Q0 " +  d.get("filename")+ " " + (i + 1) + "  "  + hits[i].score + "  Lucene" );
        }
...
//C:\Users\Rahul\Desktop\index2
    //C:\Users\Rahul\Desktop\hw4\SP
  }
